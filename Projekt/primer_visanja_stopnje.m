...
% ----- ORIGINAL KRIVULJA 4. STOPNJE NA SOZCU ----- % 
% na sliki v rdeci barvi

% Krivulja: 
plot3(X,Y,Z, 'r', 'LineWidth', 1.2)
% Kontolne tocke in kontrolni poligon:
...
% ----- ORIGINAL KRIVULJI ZVISAMO STOPNJO ----- %
% na sliki v temno modri barvi

% Kontrolne tocke in kontrolni poligon:
...
% ----- KRIVULJO PROJECIRAMO NA RAVNINO w = 1 : kroznica ----- %
% na sliki v svetlo modri barvi
